...
"background-color: rgba(42, 41, 41, 0)")
        ...
        self.icon10.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Windows_Ui/Assets/Ui/Icons/hand-phone.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.icon9.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Windows_Ui/Assets/Ui/Icons/lifesaver (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
