...
"")
        ...
        self.icon5.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Library Management/Windows_Ui/Assets/Ui/Icons/online-library.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.BACK.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Library Management/Windows_Ui/Assets/Ui/Icons/previous.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"color:rgb(28, 113, 216);")
        ...
        self.icon6.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Library Management/Windows_Ui/Assets/Ui/Icons/add-user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("Library Management/Windows_Ui/Assets/Ui/Icons/algeria.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
